...
```{r PCA results, echo=FALSE, fig.width=10, fig.height=5}
...
```{r PCA_plot2, echo=FALSE, fig.width=10, fig.height=6}
# basic plot
...
```{r UMAP_run_plot, echo=FALSE, fig.width=7, fig.height=6}
...
```{r UMAP_run_PCA, echo=FALSE, fig.width=10, fig.height=5}
# Run UMAP
set.seed(42)
...
```{r UMAP_run_PCA_plot, echo=FALSE, fig.width=20, fig.height=5}
# Plot UMAP results colored by diagnosis
